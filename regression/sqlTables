...
-- -----------------------------------------------------
-- Table `mydb`.`replicant`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`replicant` ;

CREATE TABLE IF NOT EXISTS `mydb`.`replicant` (
  `idreplicant` INT NOT NULL,
  `commonName` INT NULL,
  PRIMARY KEY (`idreplicant`))
ENGINE = InnoDB;
